...
Hi, I'm Connor van Spronssen, a Full-stack web engineer dedicated to crafting robust and user-friendly web experiences. I thrive on challenges that require a deep understanding of both front-end and back-end technologies, and I'm always eager to explore the latest advancements in the field.

My development workflow is heavily influenced by my commitment to efficiency and customization. That's why I rely on [Neovim](https://neovim.io/), a highly configurable CLI text editor that allows me to tailor my environment to my specific needs. Feel free to explore my personal Neovim configuration on [GitHub](https://github.com/Dobefu/nvim-config).

I also create various personal projects in my spare time to keep learning and improving my skills. These projects range from web applications to CLI applications, all aimed at enhancing my expertise and practical experience in the field.
