...
- The CV can easily be updated as I create new projects
- It is publically accessible on the web
- It provides a practical way for me to show off my web development skills

For the tech stack, I have chosen the following technologies:

- [MDX](https://mdxjs.com/), to have the "database" directly in version control
- [NextJS](https://nextjs.org/), for automatic hot reloading
- [TailwindCSS](https://tailwindcss.com/), for quick styling of components
...
I'm also quite fond of server components, since it reduces the final bundle size of any loaded page.

Finally, there's TailwindCSS. There's differing opinions on it out there, but I really like it.
Its main appeal for me is that I never have to switch files when styling a component.
It also provides a nice set of colours out of the box, so I don't have to think about it as much.
